 ...
 * @link https://learn.microsoft.com/en-us/windows/win32/api/winuser/ns-winuser-kbdllhookstruct#members
 */
        ...
        this.callback = Deno.UnsafeCallback.threadSafe(
            ...
            (nCode, wParam, lParam) => {
                if (nCode >= 0 && lParam !== null) {
                    ...
                    const eventName = KeyboardEventNameMap[wParam as keyof typeof KeyboardEventNameMap] ?? wParam;
